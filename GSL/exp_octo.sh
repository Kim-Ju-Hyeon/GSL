...
python3 run_ic_pnbeats_exp.py --conf_file_path ./config/IC_PN_BEATS/ic_pnbeats_ettm2.yaml --stack_num 5 --singular_stack 1 --mlp_stack 32 --mlp_num 1 --thetas_dim 32,32 &
sleep 3

export CUDA_VISIBLE_DEVICES=5
python3 run_ic_pnbeats_exp.py --conf_file_path ./config/IC_PN_BEATS/ic_pnbeats_ettm2.yaml --stack_num 5 --singular_stack 1 --mlp_stack 32 --mlp_num 3 --thetas_dim 32,32 &
sleep 3

export CUDA_VISIBLE_DEVICES=6
python3 run_ic_pnbeats_exp.py --conf_file_path ./config/IC_PN_BEATS/ic_pnbeats_ettm2.yaml --stack_num 5 --singular_stack 3 --mlp_stack 32 --mlp_num 1 --thetas_dim 32,32 &
sleep 3
#
export CUDA_VISIBLE_DEVICES=7
python3 run_ic_pnbeats_exp.py --conf_file_path ./config/IC_PN_BEATS/ic_pnbeats_ettm2.yaml --stack_num 5 --singular_stack 3 --mlp_stack 32 --mlp_num 3 --thetas_dim 32,32 &
sleep 3