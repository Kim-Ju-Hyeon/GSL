...
#python3 grid_search_pnbeats_exp.py --conf_file_path ./config/PN_BEATS/pn_beats_covid.yaml --stack_num 3 --n_pool_kernel_size 16,8,4 --n_stride_size 4,4,2 &
#sleep 3
...
python3 grid_search_pnbeats_exp.py --conf_file_path ./config/PN_BEATS/ECL/bk_loss_pn_beats_ecl.yaml --stack_num 12 --n_pool_kernel_size 16,8,4 --n_stride_size 4,4,2 &
sleep 3
