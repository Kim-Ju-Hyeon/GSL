...
python3 run_ic_pnbeats_exp.py --conf_file_path ./config/IC_PN_BEATS/Exchange/ic_pnbeats_exchange_192.yaml &
sleep 3

export CUDA_VISIBLE_DEVICES=2
python3 run_ic_pnbeats_exp.py --conf_file_path ./config/IC_PN_BEATS/Exchange/ic_pnbeats_exchange_336.yaml &
sleep 3

export CUDA_VISIBLE_DEVICES=3
python3 run_ic_pnbeats_exp.py --conf_file_path ./config/IC_PN_BEATS/Exchange/ic_pnbeats_exchange_720.yaml &
sleep 3
