...
#python3 run_dataset.py --conf_file_path ./config/IC_PN_BEATS/ECL/ic_pnbeats_ecl.yaml
#sleep 150
...
python3 run_ic_pnbeats_exp.py --conf_file_path ./config/IC_PN_BEATS/ECL/ic_pnbeats_ecl.yaml --stack_num 9 --n_pool_kernel_size 16,8,4 --n_stride_size 8,4,2 --factor 2 &
sleep 3
